...
class Trainer(object):
    ...
    def __init__(self, ml_experiment, model,
    ...
    def train(self, train_iter, epoch, report_func=None):
        ...
        self.wrap_stats_object(total_stats)
        self.wrap_stats_object(report_stats)
        ...
        for i, batch_ in self.ml_experiment.batch_loop(iterable=train_iter):
    ...
    def wrap_stats_object(self, stats_object):
        wrapped_stats = self.ml_experiment.wrap_metrics({
            'Perplexity': stats_object.ppl, 'Accuracy': stats_object.accuracy
        })
        stats_object.ppl = wrapped_stats['Perplexity']
        stats_object.accuracy = wrapped_stats['Accuracy']
