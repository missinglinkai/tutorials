import os
import random
DATA_DIR='../../AdienceFaces/DATA/aligned'
original_folds_dir='../../AdienceFaces/folds/original_txt_files'
out_files_dir='../../AdienceFaces/folds/train_val_txt_files_per_fold'
